								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="Themcauhoibtnghe?listenexerciseid=<%=request.getAttribute("listenexerciseid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msgthemcauhoibtnghe")!=null?request.getAttribute("msgthemcauhoibtnghe"):" "%>
													</label>
